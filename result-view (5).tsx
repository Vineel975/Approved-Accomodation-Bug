...
export function ResultView({
  ...
  const sendAccommodationToSpectra = async () => {
    ...
    // ── Approved Accommodation = Availed Accommodation ──────────────────────
    // Use availed accommodation directly — Spectra will set approved = availed
    // AI-determined value is secondary; availed is always the safe default
    const facilityId =
